...
from .views import (create_asset_cat,list_asset_cat,list_asset_manage,retrive_update_asset_manage,generate_csv,add_image_asset,
                   pie_chart,retrive_update_asset_type,delete_asst_type,create_asset_manage,delete_asst_mang_new,bar_chart_view)
app_name ="asset"

urlpatterns = [
    path('asset-catg/',create_asset_cat, name='asst_catg'),
    path('list-asset-cat/',list_asset_cat,name='lst_ast_catg'),
    path('assest-type-details/<int:pk>/', retrive_update_asset_type, name='record_details'),
    path('delete/<int:pk>/', delete_asst_type, name='delete_asst_cat'),
    path('asset-manage/',create_asset_manage, name='asst_manage'),
    path('list-asset-manage/',list_asset_manage,name='lst_ast_manage'),
    path('assest-manage-details/<int:pk>/', retrive_update_asset_manage, name='record_manage_details'),
